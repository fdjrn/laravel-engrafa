<div class="modal fade" id="modal-n-questioner">
  <!-- <div> -->
  <div class="modal-dialog modal-md">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Quisioner</h4>
      </div>
          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="form-group">
                ...
                <div class="col-sm-8">
                  <input type="text" id="c_qeustioner_name" name="c_qeustioner_name" class="form-control" placeholder="New Quisioner Name">
