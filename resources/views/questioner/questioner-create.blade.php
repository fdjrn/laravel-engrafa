            ...
            <div class="box box-primary ">
                ...
                <div class="box-header with-border">
                    <h4>
                        ...
                        <label class="header-cursor">New Quisioner</label>
                ...
                <form id="form_create_questioner" role="form"{{-- method="POST" action="{{route('quisioner.create')}}" --}} >
                    {{-- Main grid--}}
                    <div class="box-body" id="box-body">
                        ...
                        {{--  @csrf --}}
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" id="c_questioner_name" name="c_questioner_name" class="form-control" placeholder="New Quisioner Name">
                    ...
                    <div class="box-footer"> 
                        ...
                        <button type="submit" id="btn_save_new_quisioner" class="btn btn-primary pull-right"><!--<i class="fa fa-check"></i>-->Save</button>
                    </div>
                </form>
            </div>
        </div>
